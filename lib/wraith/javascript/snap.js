...
if (system.args.length === 3) {
    console.log('Usage: snap.js <some URL> <view port width> <target image name> <cookie array>');
    phantom.exit();
}
...
var cookies = JSON.parse(system.args[4]);
...
// Cookies are being passed in from our YAML config, and converted
// to stringified JSON, where they get passed in as an arg to snap.js.
